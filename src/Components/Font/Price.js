...
function Price({ preText, price,postText, size }) {
  const finalPrice =
  ...
  return (
    <>
      {size === "heading1" ? (
        <Heading1 text={finalPrice} />
      ) : size === "heading2" ? (
        <Heading2 text={finalPrice} />
      ) : size === "heading3" ? (
        <Heading3 text={finalPrice} />
      ) : size === "heading4" ? (
        <Heading4 text={finalPrice} />
      ) : size === "heading5" ? (
        <Heading5 text={finalPrice} />
      ) : size === "heading6" ? (
        <Heading6 text={finalPrice} />
      ) : (
        <Heading7 text={finalPrice} />
      )}
    </>
  );
}
