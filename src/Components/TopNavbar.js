      ...
      <div className="container-fluid main__navbar__container">
          ...
          <div className="navbar">
            <div className="navbar__link_block">
              ...
              <div
                onClick={() => setShowPopup(true)}
                onMouseEnter={() =>
                  navbarTab__mouseTab(true, "allcategories", 1)
                }
                // onMouseEnter={() => setNavIndex("allcategories")}
                className={
        ...
        >
          <div className="mobile__navbar__link_block">
            ...
            <div
              onClick={() =>
                mobileNavbarTab__mouseTab(!mobileShowPopup, "allcategories", 1)
              }
              // onMouseEnter={() => navbarTab__mouseTab(true, "allcategories", 1)}
              // onMouseEnter={() => setNavIndex("allcategories")}
              className={
                navIndex === "allcategories"
